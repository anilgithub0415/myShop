...
//app.use(express.static(path.join(__dirname, 'dist', 'my-Shop')));
//app.use(express.static('./dist/my-Shop'));
app.use(express.static(path.join(__dirname, 'my-Shop')));
...
// res.sendFile(path.join(__dirname, 'my-Shop/index.html'));
     res.sendFile(path.join('my-Shop','index.html');
});

// Start the server on port 8081
const port = process.env.PORT || 4200;
app.listen(port, () => {
    console.log('finding index.html at:'+path.join('dist', 'my-Shop', 'index.html'))
